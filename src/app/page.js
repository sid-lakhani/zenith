  ...
  return (
    <main className="px-5 lg:px-32 md:px-24">
      ...
      <div className="mt-8">
        ...
        <p className="mt-2 mb-4 text-lg text-gray-500">
          <span className="text-blue-400">the point in the sky directly above an observer.</span> your intellectual zenith, is a knowledge-sharing space where the collective wisdom of diverse minds converges, creating an elevated space for collaborative learning and insightful discussions.
        </p>
      </div>
      <div>
        <ForumList />
